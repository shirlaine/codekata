...
def find_needle(haystack)
  ...
  haystack.each_with_index do |item,index|
    needle_string << "found the needle at position #{index}" if item== "needle"
  end
...
p find_needle(['hay', 'junk', 'hay', 'hay', 'moreJunk', 'needle', 'randomJunk']) #'found the needle at position 5'
p find_needle(['hay', 'junk', 'hay', 'hay', 'moreJunk', 'needle', 'randomJunk']) #'found the needle at position 5'
p find_needle(['hay', 'junk', 'hay', 'hay', 'moreJunk', 'needle', 'randomJunk']) #'found the needle at position 5'
p find_needle(["hay", "junk", "hay", "hay", "moreJunk", "needle", "randomJunk"]) #'found the needle at position 5'
